...
<body>
	...
	<div class="container">
		<div class="row">
			<c:forEach var="itemType" items="${list}" varStatus="i">
				<div class="col-lg-4 col-md-6"
					style="margin-top: -15px; padding: 0 5px;">
					<div class="panel panel-primary">
						<div class="panel-heading" style="padding-left: 10px;">
							<h3 class="panel-title">
								<strong>${type[i.index]}</strong> <span class="pull-right">下载量</span>
							</h3>
						</div>
						<ul class="list-group badge-st">
							<c:forEach var="item" items="${itemType}" varStatus="j">
