...
<body>
					...
					<form action="search_show" method="post" name="searchfrm">
						<div class="input-group head-input">
							...
							<input type="text" id="titleName" name="titleName"
								...
								<button onclick="search();return false;" class="btn btn-primary">搜索</button>
							</span>
	...
	<script type="text/javascript">
		$(function(){
			$('#titleName').bind('keypress', function(event) {
				if (event.keyCode == 13)
				{
					search();
				}
		...
		function loadMeiju(data){
			...
			for(var i=0;i<t.length;i++){
				...
				$a=$('<a href="detail_show?titleId='+t[i].titleId+'" title="'+t[i].titleName+'"></a>');
				$img=$('<img src="'+t[i].picture+'">');
				$a.append($img);
				$box_img.append($a);
			 	$box_text=$('<div class="box-text" style="font-size: 12px;"></div>');
				$div_l=$('<div class="pull-left"></div>');
				$a1=$('<a href="detail_show?titleId='+t[i].titleId+'"><strong>'+t[i].titleName+'</strong></a><br>');
	...
	<div class="container main">
		<div class="col-lg-9 main-left">
			<div class="panel panel-success">
				...
				<!--	body	-->
				<div class="panel-body row" style="margin-top: -10px;" id="searchPage">

					<c:forEach var="item" items="${searchList.rows}">
