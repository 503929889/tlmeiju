							...
							<div class="box-text" style="font-size: 12px;">
								<div class="pull-left">
									...
									<span style="color: #999;">状态：</span><span
										style="color: #FF2626">更新:${item.status}</span><br>
									<span style="color: #999;">年份：</span><span>${item.year}</span>
								</div>
